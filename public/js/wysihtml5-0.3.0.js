...
wysihtml5.browser = (function() {
  ...
  return {
     ...
     *    blog-admin-web., http://, https://, ftp://, gopher://, mailto:, new:, snews:, telnet:, wasis:, file://,
 ...
 *
 * @example
 *    <div id="text-container">Please click here: blog-admin-web.google.com</div>
...
(function(wysihtml5) {
  var /**
       ...
       *
       * revision 2:
       *    /(\b(((https?|ftp):\/\/)|(blog-admin-web\.))[-A-Z0-9+&@#\/%?=~_|!:,.;\[\]]*[-A-Z0-9+&@#\/%=~_|])/gim
       *
  ...
  function _convertUrlsToLinks(str) {
    return str.replace(URL_REG_EXP, function(match, url) {
      ...
      if (realUrl.substr(0, 4) === "blog-admin-web.") {
    ...
    _initAutoLinking: function() {
      ...
      var // Use a live NodeList to check whether there are any links in the document
          ...
          getTextContent  = function(element) {
            ...
            if (textContent.substr(0, 4) === "blog-admin-web.") {
